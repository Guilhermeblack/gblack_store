# Generated by Django 3.0.8 on 2021-02-14 14:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data', models.DateTimeField(auto_now_add=True)),
                ('cliente_cli', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='Cliente', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Produto',
        ...
        migrations.AddField(
            model_name='carrinho',
            name='produto_cli',
            field=models.ManyToManyField(blank=True, related_name='produto', to='loja.Produto'),
        ),
    ]
